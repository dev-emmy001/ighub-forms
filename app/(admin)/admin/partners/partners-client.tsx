...
export default function PartnersDashboardClient({
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-3xs flex items-center gap-5 transition-all hover:shadow-2xs">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-ighub-black mt-1">{totalCount}</h3>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-3xs flex items-center gap-5 transition-all hover:shadow-2xs">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-ighub-black mt-1">{pendingCount}</h3>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-3xs flex items-center gap-5 transition-all hover:shadow-2xs">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-ighub-black mt-1">{approvedCount}</h3>
                    </div>
                </div>
            </div>
            ...
            {alertState.message && (
                <div className={`p-4 rounded-2xl shadow-md border flex items-start gap-3 animate-in slide-in-from-top-4 duration-300 ${
                ...
                <div className="flex bg-gray-150 p-1 rounded-2xl w-full md:w-auto">
                    {([
                        ...
                        <button
                            ...
                            className={`flex-1 md:flex-initial px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                                statusFilter === tab.id
